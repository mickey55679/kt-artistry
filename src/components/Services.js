...
import ServicesItem from "./Servicesitem"; // Importing ServicesItem component
import { v4 as uuidv4 } from "uuid"; // Importing uuid for generating unique IDs
import {multiplenails, spider, christmas, christmasnailart} from "./images/index"// Importing images


function Services({ addToCart, removeFromCart }) {
  const [activeFilter, setActiveFilter] = useState("all"); // State for active filter category

  // Function to update active filter category
